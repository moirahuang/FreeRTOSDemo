                           ...
                           const mbedtls_mpi *X)
{
    ...
    MBEDTLS_ASN1_CHK_ADD(
            len, mbedtls_asn1_write_tag( p, start, MBEDTLS_ASN1_INTEGER ));
                            ...
                            int boolean)
{
    ...
    *--(*p) = (boolean) ? 255 : 0;
    ...
    MBEDTLS_ASN1_CHK_ADD(len, mbedtls_asn1_write_len(p, start, len));
    MBEDTLS_ASN1_CHK_ADD(
            len, mbedtls_asn1_write_tag( p, start, MBEDTLS_ASN1_BOOLEAN ));
                                        ...
                                        const char *text, size_t text_len)
{
    ...
    MBEDTLS_ASN1_CHK_ADD(
            len,
            mbedtls_asn1_write_tag( p, start, MBEDTLS_ASN1_PRINTABLE_STRING ));
...
mbedtls_asn1_named_data *mbedtls_asn1_store_named_data(
        mbedtls_asn1_named_data **head, const char *oid, size_t oid_len,
