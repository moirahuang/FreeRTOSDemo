...
typedef enum
{
    ECP_TYPE_NONE = 0, ECP_TYPE_SHORT_WEIERSTRASS, /* y^2 = x^3 + a x + b      */
                    ...
                    int (*f_rng)(void *, unsigned char *, size_t), void *p_rng)
{
    ...
    if ((ret = mbedtls_ecp_check_privkey(grp, m)) != 0 || (ret =
                               ...
                               const mbedtls_ecp_keypair *prv)
{
    ...
    cleanup: mbedtls_ecp_point_free(&Q);
